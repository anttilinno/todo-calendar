...
Plans:
- [x] 27-01-PLAN.md -- Schema migration, date precision storage, and precision-aware store queries
- [x] 27-02-PLAN.md -- Segmented date input UI with format-aware ordering and precision derivation

# Requirements Archive: v2.2 Google Calendar Events
...
- [x] **DISP-01**: Timed events show HH:MM time prefix (e.g., "09:00 Team Standup")
- [x] **DISP-02**: All-day events show "all day" label instead of time
- [x] **DISP-03**: Events visually distinct from todos — no checkbox, distinct foreground color, time prefix
- [x] **DISP-04**: Events sorted above todos within the dated section (events first, then todos)
- [x] **DISP-05**: Events are not selectable — cursor skips over event items in the todo list
- [x] **DISP-06**: Multi-day events expanded to show on each day they span
- [x] **DISP-07**: Events respect monthly view filtering (only current month's events shown)
- [x] **DISP-08**: Events respect weekly view filtering (only current week's events shown)

### Calendar Grid

- [x] **GRID-01**: Calendar grid day indicators include event presence (days with events show indicator even without todos)

### Configuration

- [x] **CONF-01**: Google Calendar toggle in settings overlay (enable/disable without removing credentials)
...
| DISP-01 | Phase 35 | Done |
| DISP-02 | Phase 35 | Done |
| DISP-03 | Phase 35 | Done |
| DISP-04 | Phase 35 | Done |
| DISP-05 | Phase 35 | Done |
| DISP-06 | Phase 35 | Done |
| DISP-07 | Phase 35 | Done |
| DISP-08 | Phase 35 | Done |
| GRID-01 | Phase 35 | Done |
| CONF-01 | Phase 35 | Done |
